...
final case class TaskRequest(
    ...
    private[this] def __computeSerializedValue(): _root_.scala.Int = {
      ...
      if (taskType != com.jalebi.proto.jobmanagement.TaskType.LOAD_DATASET) { __size += _root_.com.google.protobuf.CodedOutputStream.computeEnumSize(3, taskType.value) }
      if (startVertexId != 0L) { __size += _root_.com.google.protobuf.CodedOutputStream.computeInt64Size(4, startVertexId) }
      if (dataset != "") { __size += _root_.com.google.protobuf.CodedOutputStream.computeStringSize(5, dataset) }
      parts.foreach(parts => __size += _root_.com.google.protobuf.CodedOutputStream.computeStringSize(6, parts))
      if (limit != 0L) { __size += _root_.com.google.protobuf.CodedOutputStream.computeInt64Size(7, limit) }
      __size
    }
    ...
    def withTaskId(__v: _root_.scala.Predef.String): TaskRequest = copy(taskId = __v)
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 3 => _root_.scalapb.descriptors.PEnum(taskType.scalaValueDescriptor)
        case 4 => _root_.scalapb.descriptors.PLong(startVertexId)
        case 5 => _root_.scalapb.descriptors.PString(dataset)
        case 6 => _root_.scalapb.descriptors.PRepeated(parts.map(_root_.scalapb.descriptors.PString)(_root_.scala.collection.breakOut))
        case 7 => _root_.scalapb.descriptors.PLong(limit)
      }
    }
...
object TaskRequest extends scalapb.GeneratedMessageCompanion[com.jalebi.proto.jobmanagement.TaskRequest] {
  ...
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): com.jalebi.proto.jobmanagement.TaskRequest = {
    ...
    com.jalebi.proto.jobmanagement.TaskRequest(
      ...
      com.jalebi.proto.jobmanagement.TaskType.fromValue(__fieldsMap.getOrElse(__fields.get(2), com.jalebi.proto.jobmanagement.TaskType.LOAD_DATASET.javaValueDescriptor).asInstanceOf[_root_.com.google.protobuf.Descriptors.EnumValueDescriptor].getNumber),
  ...
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.jalebi.proto.jobmanagement.TaskRequest] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      com.jalebi.proto.jobmanagement.TaskRequest(
        ...
        com.jalebi.proto.jobmanagement.TaskType.fromValue(__fieldsMap.get(scalaDescriptor.findFieldByNumber(3).get).map(_.as[_root_.scalapb.descriptors.EnumValueDescriptor]).getOrElse(com.jalebi.proto.jobmanagement.TaskType.LOAD_DATASET.scalaValueDescriptor).number),
  ...
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = {
    (__fieldNumber: @_root_.scala.unchecked) match {
      case 3 => com.jalebi.proto.jobmanagement.TaskType
    }
  }
  ...
  final val TASKTYPE_FIELD_NUMBER = 3
  final val STARTVERTEXID_FIELD_NUMBER = 4
  final val DATASET_FIELD_NUMBER = 5
  final val PARTS_FIELD_NUMBER = 6
