...
final case class TaskResponse(
    ...
    taskId: _root_.scala.Predef.String = "",
    taskState: com.jalebi.proto.jobmanagement.TaskState = com.jalebi.proto.jobmanagement.TaskState.RUNNING,
    ...
    private[this] def __computeSerializedValue(): _root_.scala.Int = {
      ...
      if (taskId != "") { __size += _root_.com.google.protobuf.CodedOutputStream.computeStringSize(2, taskId) }
      if (taskState != com.jalebi.proto.jobmanagement.TaskState.RUNNING) { __size += _root_.com.google.protobuf.CodedOutputStream.computeEnumSize(3, taskState.value) }
      if (executorId != "") { __size += _root_.com.google.protobuf.CodedOutputStream.computeStringSize(4, executorId) }
      if (executorState != com.jalebi.proto.jobmanagement.ExecutorState.NEW) { __size += _root_.com.google.protobuf.CodedOutputStream.computeEnumSize(5, executorState.value) }
      if (datasetState != com.jalebi.proto.jobmanagement.DatasetState.NONE) { __size += _root_.com.google.protobuf.CodedOutputStream.computeEnumSize(6, datasetState.value) }
    ...
    def writeTo(`_output__`: _root_.com.google.protobuf.CodedOutputStream): _root_.scala.Unit = {
      ...
      {
        val __v = taskState
        if (__v != com.jalebi.proto.jobmanagement.TaskState.RUNNING) {
    ...
    def mergeFrom(`_input__`: _root_.com.google.protobuf.CodedInputStream): com.jalebi.proto.jobmanagement.TaskResponse = {
      ...
      var __taskState = this.taskState
      ...
      while (!_done__) {
        ...
        _tag__ match {
          ...
          case 18 =>
            __taskId = _input__.readString()
          case 24 =>
            __taskState = com.jalebi.proto.jobmanagement.TaskState.fromValue(_input__.readEnum())
          case 34 =>
    ...
    def withTaskId(__v: _root_.scala.Predef.String): TaskResponse = copy(taskId = __v)
    def withTaskState(__v: com.jalebi.proto.jobmanagement.TaskState): TaskResponse = copy(taskState = __v)
    ...
    def getFieldByNumber(__fieldNumber: _root_.scala.Int): scala.Any = {
      (__fieldNumber: @_root_.scala.unchecked) match {
        ...
        case 3 => {
          val __t = taskState.javaValueDescriptor
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 2 => _root_.scalapb.descriptors.PString(taskId)
        case 3 => _root_.scalapb.descriptors.PEnum(taskState.scalaValueDescriptor)
        case 4 => _root_.scalapb.descriptors.PString(executorId)
        case 5 => _root_.scalapb.descriptors.PEnum(executorState.scalaValueDescriptor)
        case 6 => _root_.scalapb.descriptors.PEnum(datasetState.scalaValueDescriptor)
        case 7 => _root_.scalapb.descriptors.PRepeated(vertexResults.map(_.toPMessage)(_root_.scala.collection.breakOut))
        case 8 => _root_.scalapb.descriptors.PRepeated(edgeResults.map(_.toPMessage)(_root_.scala.collection.breakOut))
      }
    }
...
object TaskResponse extends scalapb.GeneratedMessageCompanion[com.jalebi.proto.jobmanagement.TaskResponse] {
  ...
  def fromFieldsMap(__fieldsMap: scala.collection.immutable.Map[_root_.com.google.protobuf.Descriptors.FieldDescriptor, scala.Any]): com.jalebi.proto.jobmanagement.TaskResponse = {
    ...
    com.jalebi.proto.jobmanagement.TaskResponse(
      ...
      com.jalebi.proto.jobmanagement.TaskState.fromValue(__fieldsMap.getOrElse(__fields.get(2), com.jalebi.proto.jobmanagement.TaskState.RUNNING.javaValueDescriptor).asInstanceOf[_root_.com.google.protobuf.Descriptors.EnumValueDescriptor].getNumber),
      __fieldsMap.getOrElse(__fields.get(3), "").asInstanceOf[_root_.scala.Predef.String],
      com.jalebi.proto.jobmanagement.ExecutorState.fromValue(__fieldsMap.getOrElse(__fields.get(4), com.jalebi.proto.jobmanagement.ExecutorState.NEW.javaValueDescriptor).asInstanceOf[_root_.com.google.protobuf.Descriptors.EnumValueDescriptor].getNumber),
      com.jalebi.proto.jobmanagement.DatasetState.fromValue(__fieldsMap.getOrElse(__fields.get(5), com.jalebi.proto.jobmanagement.DatasetState.NONE.javaValueDescriptor).asInstanceOf[_root_.com.google.protobuf.Descriptors.EnumValueDescriptor].getNumber),
      __fieldsMap.getOrElse(__fields.get(6), Nil).asInstanceOf[_root_.scala.collection.Seq[com.jalebi.proto.jobmanagement.VertexResult]],
      __fieldsMap.getOrElse(__fields.get(7), Nil).asInstanceOf[_root_.scala.collection.Seq[com.jalebi.proto.jobmanagement.EdgeResult]]
    )
  }
  implicit def messageReads: _root_.scalapb.descriptors.Reads[com.jalebi.proto.jobmanagement.TaskResponse] = _root_.scalapb.descriptors.Reads{
    case _root_.scalapb.descriptors.PMessage(__fieldsMap) =>
      ...
      com.jalebi.proto.jobmanagement.TaskResponse(
        ...
        com.jalebi.proto.jobmanagement.TaskState.fromValue(__fieldsMap.get(scalaDescriptor.findFieldByNumber(3).get).map(_.as[_root_.scalapb.descriptors.EnumValueDescriptor]).getOrElse(com.jalebi.proto.jobmanagement.TaskState.RUNNING.scalaValueDescriptor).number),
        __fieldsMap.get(scalaDescriptor.findFieldByNumber(4).get).map(_.as[_root_.scala.Predef.String]).getOrElse(""),
        com.jalebi.proto.jobmanagement.ExecutorState.fromValue(__fieldsMap.get(scalaDescriptor.findFieldByNumber(5).get).map(_.as[_root_.scalapb.descriptors.EnumValueDescriptor]).getOrElse(com.jalebi.proto.jobmanagement.ExecutorState.NEW.scalaValueDescriptor).number),
        com.jalebi.proto.jobmanagement.DatasetState.fromValue(__fieldsMap.get(scalaDescriptor.findFieldByNumber(6).get).map(_.as[_root_.scalapb.descriptors.EnumValueDescriptor]).getOrElse(com.jalebi.proto.jobmanagement.DatasetState.NONE.scalaValueDescriptor).number),
        __fieldsMap.get(scalaDescriptor.findFieldByNumber(7).get).map(_.as[_root_.scala.collection.Seq[com.jalebi.proto.jobmanagement.VertexResult]]).getOrElse(_root_.scala.collection.Seq.empty),
        __fieldsMap.get(scalaDescriptor.findFieldByNumber(8).get).map(_.as[_root_.scala.collection.Seq[com.jalebi.proto.jobmanagement.EdgeResult]]).getOrElse(_root_.scala.collection.Seq.empty)
      )
  ...
  def messageCompanionForFieldNumber(__number: _root_.scala.Int): _root_.scalapb.GeneratedMessageCompanion[_] = {
    ...
    (__number: @_root_.scala.unchecked) match {
      case 7 => __out = com.jalebi.proto.jobmanagement.VertexResult
      case 8 => __out = com.jalebi.proto.jobmanagement.EdgeResult
    }
    __out
  }
  ...
  def enumCompanionForFieldNumber(__fieldNumber: _root_.scala.Int): _root_.scalapb.GeneratedEnumCompanion[_] = {
    (__fieldNumber: @_root_.scala.unchecked) match {
      case 3 => com.jalebi.proto.jobmanagement.TaskState
      case 5 => com.jalebi.proto.jobmanagement.ExecutorState
      case 6 => com.jalebi.proto.jobmanagement.DatasetState
    }
  }
  ...
  implicit class TaskResponseLens[UpperPB](_l: _root_.scalapb.lenses.Lens[UpperPB, com.jalebi.proto.jobmanagement.TaskResponse]) extends _root_.scalapb.lenses.ObjectLens[UpperPB, com.jalebi.proto.jobmanagement.TaskResponse](_l) {
    ...
    def taskId: _root_.scalapb.lenses.Lens[UpperPB, _root_.scala.Predef.String] = field(_.taskId)((c_, f_) => c_.copy(taskId = f_))
    def taskState: _root_.scalapb.lenses.Lens[UpperPB, com.jalebi.proto.jobmanagement.TaskState] = field(_.taskState)((c_, f_) => c_.copy(taskState = f_))
  ...
  final val TASKID_FIELD_NUMBER = 2
  final val TASKSTATE_FIELD_NUMBER = 3
  final val EXECUTORID_FIELD_NUMBER = 4
  final val EXECUTORSTATE_FIELD_NUMBER = 5
  final val DATASETSTATE_FIELD_NUMBER = 6
  final val VERTEXRESULTS_FIELD_NUMBER = 7
  final val EDGERESULTS_FIELD_NUMBER = 8
}
