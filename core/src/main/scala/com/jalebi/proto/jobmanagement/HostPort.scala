...
final case class HostPort(
    ...
    private[this] def __computeSerializedValue(): _root_.scala.Int = {
      ...
      if (host != "") { __size += _root_.com.google.protobuf.CodedOutputStream.computeStringSize(2, host) }
      if (port != 0L) { __size += _root_.com.google.protobuf.CodedOutputStream.computeInt64Size(3, port) }
      __size
    }
    ...
    def withScheme(__v: _root_.scala.Predef.String): HostPort = copy(scheme = __v)
    ...
    def getField(__field: _root_.scalapb.descriptors.FieldDescriptor): _root_.scalapb.descriptors.PValue = {
      ...
      (__field.number: @_root_.scala.unchecked) match {
        ...
        case 3 => _root_.scalapb.descriptors.PLong(port)
      }
    }
...
object HostPort extends scalapb.GeneratedMessageCompanion[com.jalebi.proto.jobmanagement.HostPort] {
  ...
  def javaDescriptor: _root_.com.google.protobuf.Descriptors.Descriptor = JobmanagementProto.javaDescriptor.getMessageTypes.get(6)
  def scalaDescriptor: _root_.scalapb.descriptors.Descriptor = JobmanagementProto.scalaDescriptor.messages(6)
